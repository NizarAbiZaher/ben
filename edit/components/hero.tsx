            ...
            <div className="text-center px-8">
                <div className="mb-6" data-aos='fade-down'>
                    <div className="relative inline-flex before:absolute before:inset-0">
                        <Link href='https://twitter.com/BenVFXs' className="px-3 py-1 text-sm font-medium inline-flex items-center justify-center border rounded-full text-zinc-300 hover:text-white transition duration-150 ease-in-out w-full group border-slate-100/40" target="_blank">
